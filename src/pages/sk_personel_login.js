...
const SkpersonelLogin = () => {
  ...
  useEffect(() => {
    const savedUsername = localStorage.getItem('rememberedSkUsername');
    if (savedUsername) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (rememberUsername) {
      localStorage.setItem('rememberedSkUsername', username);
    } else {
      localStorage.removeItem('rememberedSkUsername');
    }
  ...
  return (
    <Box
      ...
      role="main"
      aria-label="SK Personnel Login page"
    >
