  ...
  const ComplaintCard = ({ complaint }) => (
    <Card sx={{ 
      ...
      <CardContent sx={{ 
        ...
        {/* BAKLAS PLAKA Indicator - Add here */}
        {(complaint.driver_info && complaint.driver_info.ticket_count >= 3) && (
          <Box 
            sx={{ 
              p: { xs: 1, sm: 1.5 },
              bgcolor: 'error.main',
          ...
          >
            ...
            >
              FRANCHISE PLATE: {complaint.franchise_plate_no}
            </Typography>
            <Typography 
              variant="caption" 
              sx={{ 
            ...
            >
              3+ OFFENSES - PLATE CONFISCATION REQUIRED
            </Typography>
          </Box>
        )}
